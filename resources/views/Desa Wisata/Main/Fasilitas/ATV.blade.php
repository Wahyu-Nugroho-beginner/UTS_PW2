...
@section('content')
                ...
                <div class="btn-group">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('fasilitas.show', 'makanan') }}">Makan Gratis</a>
                            </li>
                        </ul>
                    </div>
    ...
    <main class="container hero my-5">
        <div class="fasilitas-banner">
            <div class="banner-images">
                <div class="banner-img">
                    <img src="{{ asset('images/atv1.png') }}" alt="ATV 1"
                        onerror="this.src='https://via.placeholder.com/800x360?text=ATV+1'">
                </div>
                <div class="banner-img">
                    <img src="{{ asset('images/atv2.png') }}" alt="ATV 2"
                        onerror="this.src='https://via.placeholder.com/800x360?text=ATV+2'">
                </div>
                <div class="banner-img">
                    <img src="{{ asset('images/atv3.png') }}" alt="ATV 3"
                        onerror="this.src='https://via.placeholder.com/800x360?text=ATV+3'">
                </div>
            </div>
        ...
        <div class="fasilitas-banner" style="background-color:#ffffff; padding:20px 0;">
            <div class="banner-images">
                <div class="banner-img">
                    <img src="{{ asset('images/ATV-BG2.png') }}" alt="ATV-BG 2"
                        onerror="this.src='https://via.placeholder.com/800x360?text=ATV+2'">
                </div>
                <div class="banner-img">
                    <img src="{{ asset('images/ATV-BG1.png') }}" alt="ATV-BG 1"
                        onerror="this.src='https://via.placeholder.com/800x360?text=ATV+1'">
                </div>
                <div class="banner-img">
                    <img src="{{ asset('images/ATV-BG3.png') }}" alt="ATV-BG 3"
                        onerror="this.src='https://via.placeholder.com/800x360?text=ATV+3'">
                </div>
            </div>
