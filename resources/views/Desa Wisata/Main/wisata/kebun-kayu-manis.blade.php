        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <p class="text-justify mt-3">
                    Selain terkenal dengan teh dan kopi, Kayu Aro juga memiliki potensi alam yang tak kalah menarik, yaitu
                    kebun kayu manis (kulit manis atau cinnamon). Tanaman ini tumbuh subur di dataran tinggi Kayu Aro yang
                    berhawa sejuk dan memiliki tanah vulkanik yang kaya unsur hara. Kayu manis Kerinci bahkan telah dikenal
                    secara internasional sebagai salah satu kayu manis terbaik di dunia, dengan aroma kuat dan cita rasa
                    manis yang khas.
                </p>
                <p class="text-justify">
                    Kebun kayu manis di Kayu Aro tidak hanya menjadi sumber ekonomi utama bagi sebagian masyarakat, tetapi
                    juga berkembang menjadi objek wisata edukatif dan agrowisata. Wisatawan dapat melihat langsung proses
                    penanaman hingga pengupasan kulit kayu manis, yang dilakukan dengan cara tradisional oleh petani
                    setempat.
                </p>
                <p class="text-justify">
                    Dari perkebunan yang luas ini, pengunjung juga dapat menikmati pemandangan indah pegunungan Bukit
                    Barisan dan hamparan kebun kopi yang berdampingan, menciptakan suasana tenang dan alami khas pedesaan
                    Kerinci.
                </p>
            </div>
            <div class="col-lg-5 text-center mt-4 mt-lg-0">
                <div class="img-frame mx-auto" style="max-width:420px">
                    <img src="{{ asset('images/kayu_manis.png') }}" alt="Danau Kerinci"
                        onerror="this.src='https://via.placeholder.com/600x400?text=Danau+Kerinci'">
                </div>
                <a href="https://maps.app.goo.gl/Gjaxr2T8kS4bd6pM9" class="mt-3">Lokasi: Kebun Baru, Kecamatan Kayu Aro
