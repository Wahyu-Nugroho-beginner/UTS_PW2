        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <p class="text-justify mt-3">
                    Terletak di wilayah Kabupaten Kerinci, Provinsi Jambi, tidak jauh dari kawasan Kayu Aro, terdapat sebuah
                    destinasi alam yang menakjubkan Danau Kerinci. Danau ini merupakan danau alami terbesar di Provinsi
                    Jambi, dengan luas mencapai sekitar 4.200 hektar, berada di ketinggian ±783 meter di atas permukaan
                    laut.
                </p>
                <p class="text-justify">
                    Dikelilingi oleh perbukitan hijau dan udara yang sejuk, Danau Kerinci menawarkan pemandangan alam yang
                    menenangkan dan memesona. Permukaan airnya yang biru jernih memantulkan bayangan langit dan pegunungan
                    di sekitarnya, menciptakan suasana damai yang sangat cocok untuk bersantai, berfoto, atau menikmati
                    matahari terbenam di tepian danau.
                </p>
                <p class="text-justify">
                    Selain keindahan alamnya, kawasan Danau Kerinci juga menjadi pusat berbagai aktivitas wisata dan budaya.
                    Setiap tahun diadakan Festival Danau Kerinci, yang menampilkan beragam kesenian tradisional, lomba
                    perahu, hingga pameran hasil bumi dan kerajinan masyarakat lokal.
                </p>
            </div>
            <div class="col-lg-5 text-center mt-4 mt-lg-0">
                <div class="img-frame mx-auto" style="max-width:420px">
                    <img src="{{ asset('images/danau_kerinci.png') }}" alt="Danau Kerinci"
