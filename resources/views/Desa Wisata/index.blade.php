...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
        <div class="container">
            <div>
                <P class="text-danger" class="text-decoration-line-through">Silahkan Login Terlebih Dahulu Untuk Info Lebih
                    Lanjut</P>
            </div>
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <p class="text-justify mt-3">Kayu Aro merupakan sebuah kecamatan di Kabupaten Kerinci, Jambi, Indonesia.
                    ...
                    47/1996. Pusat pemerintahan di Desa Tanjung Bungo. Sebelumnya pusat pemerintahan terletak di Desa Batang
                    Sangir.</p>
                <p class="text-justify">Desa Kayu Aro terletak di Kecamatan Kayu Aro, Kabupaten Kerinci, Provinsi Jambi, di
                    lereng indah Gunung Kerinci, gunung tertinggi di Sumatera. Dikenal dengan udara yang sejuk dan
                    pemandangan alam yang menakjubkan, Kayu Aro menjadi salah satu destinasi wisata alam dan agrowisata
                    unggulan di Kerinci.</p>
                <p class="text-justify">Desa ini dikelilingi hamparan perkebunan kopi arabika dan teh Kayu Aro yang terkenal
                    hingga mancanegara. Keindahan alam pegunungan, sawah bertingkat, serta keramahan masyarakatnya
                    menjadikan Kayu Aro tempat ideal untuk menikmati wisata alam, budaya, dan edukasi pertanian.</p>
            </div>
