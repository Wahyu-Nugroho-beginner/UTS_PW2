        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <p class="text-justify mt-3">
                    Berlokasi di kawasan Kayu Aro, Kabupaten Kerinci, Provinsi Jambi, Gunung Kerinci berdiri megah sebagai
                    gunung berapi tertinggi di Indonesia dan gunung tertinggi di Pulau Sumatera, dengan ketinggian mencapai
                    3.805 meter di atas permukaan laut. Gunung ini merupakan ikon kebanggaan masyarakat Kerinci sekaligus
                    daya tarik utama wisata alam di kawasan Taman Nasional Kerinci Seblat (TNKS), yang telah diakui sebagai
                    Warisan Dunia UNESCO.
                </p>
                <p class="text-justify">
                    Gunung Kerinci menawarkan pengalaman wisata yang luar biasa bagi para pencinta alam dan pendaki. Jalur
                    pendakiannya dimulai dari Desa Kersik Tuo, Kecamatan Kayu Aro, yang menjadi gerbang utama pendakian.
                    Dari sini, pendaki akan melewati hutan tropis yang lebat, sumber air alami, serta berbagai flora dan
                    fauna endemik seperti burung rangkong, siamang, dan harimau sumatera.
                </p>
                <p class="text-justify">
                    Selain pendakian, kawasan Gunung Kerinci juga menyuguhkan pemandangan spektakuler. Dari puncaknya,
                    pendaki dapat menyaksikan pemandangan Danau Kerinci, hamparan kebun teh Kayu Aro, dan garis pantai barat
                    Sumatera di kejauhan. Udara sejuk, aroma hutan yang segar, dan suasana damai menjadikan kawasan ini
                    destinasi sempurna untuk wisata petualangan dan ekowisata.
                </p>
            </div>
            <div class="col-lg-5 text-center mt-4 mt-lg-0">
                <div class="img-frame mx-auto" style="max-width:420px">
                    <img src="{{ asset('images/gunung_kerinci.png') }}" alt="Danau Kerinci"
                        onerror="this.src='https://via.placeholder.com/600x400?text=Danau+Kerinci'">
                </div>
                <a href="https://maps.app.goo.gl/TeNJLpPpKHi286GCA" class="mt-3">Lokasi: Lubuk Gadang Sel., Kec. Sangir,
                    Kabupaten Solok Selatan, Sumatera Barat</a>
            </div>
        </div>
